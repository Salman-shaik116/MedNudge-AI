...
urlpatterns = [
    ...
    path('api/notifications/due/', views.due_notifications_api, name='due_notifications_api'),
    path('api/notifications/ack/', views.ack_notifications_api, name='ack_notifications_api'),
    path('api/notifications/taken/', views.notification_taken_api, name='notification_taken_api'),
    path('api/notifications/snooze/', views.notification_snooze_api, name='notification_snooze_api'),
    ...
    path('api/reminder-plan/item/', views.upsert_reminder_item_api, name='upsert_reminder_item_api'),
    path('api/reminder-plan/item/delete/', views.delete_reminder_item_api, name='delete_reminder_item_api'),
    # Doctor URLs
